...
function init() {
  ...
  camera = new THREE.PerspectiveCamera(isMobile ? 16 : 28, window.innerWidth / window.innerHeight, 0.1, 2000);
  camera.position.set(0, isMobile ? 10.2 : 9.2, isMobile ? 96 : 56);
  ...
  controls.minDistance = window.innerWidth <= 768 ? 20 : 12;
  controls.maxDistance = window.innerWidth <= 768 ? 42 : 26;
