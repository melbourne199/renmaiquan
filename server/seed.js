...
// 真实省-市-区层级数据
const realRegions = [
  { province: '广东省', city: '深圳市', districts: ['南山区', '福田区', '龙岗区', '宝安区', '罗湖区', '龙华区', '光明区', '坪山区'] },
  { province: '广东省', city: '广州市', districts: ['天河区', '越秀区', '海珠区', '番禺区', '白云区', '黄埔区', '荔湾区', '花都区'] },
  { province: '广东省', city: '东莞市', districts: ['南城街道', '莞城街道', '东城街道', '万江街道', '松山湖'] },
  { province: '广东省', city: '佛山市', districts: ['禅城区', '南海区', '顺德区', '三水区', '高明区'] },
  { province: '广东省', city: '珠海市', districts: ['香洲区', '斗门区', '金湾区', '横琴新区'] },
  { province: '北京市', city: '北京市', districts: ['朝阳区', '海淀区', '东城区', '西城区', '丰台区', '通州区', '大兴区', '昌平区'] },
  { province: '上海市', city: '上海市', districts: ['浦东新区', '黄浦区', '徐汇区', '静安区', '长宁区', '闵行区', '宝山区', '嘉定区'] },
  { province: '浙江省', city: '杭州市', districts: ['西湖区', '滨江区', '余杭区', '萧山区', '拱墅区', '上城区', '临平区', '钱塘区'] },
  { province: '浙江省', city: '宁波市', districts: ['鄞州区', '海曙区', '江北区', '镇海区', '北仑区'] },
  { province: '江苏省', city: '南京市', districts: ['鼓楼区', '建邺区', '玄武区', '秦淮区', '雨花台区', '栖霞区', '江宁区', '浦口区'] },
  { province: '江苏省', city: '苏州市', districts: ['姑苏区', '虎丘区', '吴中区', '相城区', '吴江区', '工业园区'] },
  { province: '四川省', city: '成都市', districts: ['武侯区', '锦江区', '青羊区', '金牛区', '高新区', '天府新区', '龙泉驿区'] },
  { province: '湖北省', city: '武汉市', districts: ['武昌区', '洪山区', '江汉区', '汉阳区', '江岸区', '东湖高新区', '经济开发区'] },
  { province: '陕西省', city: '西安市', districts: ['雁塔区', '碑林区', '莲湖区', '高新区', '经开区', '未央区', '灞桥区'] },
  { province: '重庆市', city: '重庆市', districts: ['渝中区', '江北区', '南岸区', '沙坪坝区', '九龙坡区', '渝北区', '两江新区'] },
  { province: '天津市', city: '天津市', districts: ['南开区', '河西区', '和平区', '河东区', '河北区', '滨海新区', '西青区'] },
  { province: '福建省', city: '厦门市', districts: ['思明区', '湖里区', '集美区', '海沧区', '翔安区', '同安区'] },
  { province: '湖南省', city: '长沙市', districts: ['芙蓉区', '天心区', '岳麓区', '雨花区', '开福区', '望城区'] },
  { province: '山东省', city: '青岛市', districts: ['市南区', '市北区', '崂山区', '黄岛区', '城阳区', '即墨区'] },
  { province: '辽宁省', city: '大连市', districts: ['中山区', '西岗区', '沙河口区', '甘井子区', '高新区'] },
];
...
async function seed() {
  try {
    ...
    // 生成政务资源 50 条（使用真实省-市-区层级）
    console.log('🏛️ 生成政务资源...');
    for (let i = 0; i < 50; i++) {
      const status = Math.random() > 0.2 ? 1 : 0;
      const region = randomItem(realRegions);
      ...
      await GovernmentResource.create({
        ...
        city: region.city,
        district: district,
        level_code: randomItem(['顶层', '省级', '市级', '区级', '镇街级']),
